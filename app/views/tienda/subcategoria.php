...
function tienda_img_url($img) {
    ...
    if (str_starts_with($img, 'http://') || str_starts_with($img, 'https://')) {
        ...
        // servir la foto original de varios MB para una miniatura pequeña)
        if (str_contains($img, 'res.cloudinary.com') && str_contains($img, '/upload/')) {
            return str_replace('/upload/', '/upload/w_500,q_auto,f_auto/', $img);
        }
        return $img;
    }
    ...
    <div class="row">
            ...
            <div class="card sticky-top" style="top: 130px;">
                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        ...
                        <div class="collapse" id="sub_<?php echo $cat['id']; ?>">
                            <div class="list-group list-group-flush">
                                <?php if (!empty($cat['subcategorias'])): ?>
                                    <?php foreach ($cat['subcategorias'] as $sub): ?>
                                    <a href="<?php echo APP_URL . '/' . sanitizar($_SESSION['tenant_slug']); ?>/index.php?controller=tienda&action=subcategoria&id=<?php echo $sub['id']; ?>" 
        ...
        <div class="col-lg-9">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo APP_URL . '/' . sanitizar($_SESSION['tenant_slug']); ?>">Inicio</a></li>
                    <li class="breadcrumb-item"><a href="<?php echo APP_URL . '/' . sanitizar($_SESSION['tenant_slug']); ?>/index.php?controller=tienda&action=categoria&id=<?php echo $subcategoria['categoria_id']; ?>">
                        <?php echo sanitizar($subcategoria['categoria']); ?>
                    </a></li>
                    <li class="breadcrumb-item active"><?php echo sanitizar($subcategoria['nombre']); ?></li>
                </ol>
            </nav>
            ...
            <div class="row mb-4 g-2">
                <div class="col-md-6">
                    <form method="GET" class="input-group">
                        ...
                        <input type="hidden" name="action" value="subcategoria">
                ...
                <div class="col-md-6">
                    <select class="form-select" id="ordenSelect" onchange="cambiarOrden(this.value, '<?php echo $subcategoria['id']; ?>')">
            ...
            <?php if (empty($productos)): ?>
                <div class="col-12">
                    <div class="alert alert-warning" style="padding: 40px; text-align: center; border-radius: 12px;">
                        ...
                        <p style="margin: 10px 0 0 0;">No hay productos disponibles en esta subcategoría. Por favor, vuelve más tarde.</p>
                    </div>
                </div>
            <?php else: ?>
                    ...
                    <div class="product-card" data-galeria="<?php echo $galeriaAttr; ?>">
                        ...
                        <div class="product-info">
                            <h5 class="product-title">
                                <a href="<?php echo APP_URL . '/' . sanitizar($_SESSION['tenant_slug']); ?>/index.php?controller=tienda&action=producto&id=<?php echo $producto['id']; ?>" class="product-title-link">
            ...
            <nav aria-label="Paginación" class="mt-5">
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item <?php echo $pagina_actual <= 1 ? 'disabled' : ''; ?>">
                        <a class="page-link" href="<?php echo $pagina_actual > 1 ? $this->construirUrlPaginacionSubcategoria($pagina_actual - 1, $subcategoria['id']) : '#'; ?>">
                    ...
                    if ($inicio > 1) {
                        echo '<li class="page-item"><a class="page-link" href="' . $this->construirUrlPaginacionSubcategoria(1, $subcategoria['id']) . '">1</a></li>';
                        if ($inicio > 2) {
                    ...
                    for ($i = $inicio; $i <= $fin; $i++) {
                        ...
                        echo '<li class="page-item ' . $activa . '"><a class="page-link" href="' . $this->construirUrlPaginacionSubcategoria($i, $subcategoria['id']) . '">' . $i . '</a></li>';
                    }
                    ...
                    if ($fin < $total_paginas) {
                        ...
                        echo '<li class="page-item"><a class="page-link" href="' . $this->construirUrlPaginacionSubcategoria($total_paginas, $subcategoria['id']) . '">' . $total_paginas . '</a></li>';
                    }
                    ?>

                    <!-- Página siguiente -->
                    <li class="page-item <?php echo $pagina_actual >= $total_paginas ? 'disabled' : ''; ?>">
                        <a class="page-link" href="<?php echo $pagina_actual < $total_paginas ? $this->construirUrlPaginacionSubcategoria($pagina_actual + 1, $subcategoria['id']) : '#'; ?>">
...
<script>
function cambiarOrden(valor, subcategoriaId) {
    const url = new URL(window.location);
    const busqueda = document.querySelector('input[name="busqueda"]')?.value || '';
    
    url.searchParams.set('controller', 'tienda');
    url.searchParams.set('action', 'subcategoria');
    url.searchParams.set('id', subcategoriaId);
