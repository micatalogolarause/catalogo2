...
function admin_producto_img_url($img) {
    ...
    if (str_starts_with($img, 'http://') || str_starts_with($img, 'https://')) {
        ...
        if (str_contains($img, 'res.cloudinary.com') && str_contains($img, '/upload/')) {
            return str_replace('/upload/', '/upload/w_300,q_auto,f_auto/', $img);
        }
        return $img;
    }
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?php echo tenant_base_url(); ?>/index.php?controller=admin&action=productos" class="btn btn-secondary">
