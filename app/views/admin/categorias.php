...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?php echo tenant_base_url(); ?>/index.php?controller=admin&action=crearCategoria" class="btn btn-primary">
...
<form method="GET" class="mb-4">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <a href="<?php echo tenant_base_url(); ?>/index.php?controller=admin&action=categorias" class="btn btn-secondary w-100 mt-2">
        ...
        <tbody>
            ...
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo tenant_base_url(); ?>/index.php?controller=admin&action=editarCategoria&id=<?php echo $cat['id']; ?>" 
                           class="btn btn-sm btn-warning"><i class="bi bi-pencil"></i></a>
                        <form method="POST" action="<?php echo tenant_base_url(); ?>/index.php?controller=admin&action=eliminarCategoria" 
