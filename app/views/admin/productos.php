...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="btn-group">
        <a href="<?php echo tenant_base_url(); ?>/index.php?controller=admin&action=crearProducto" class="btn btn-primary">
        ...
        <div class="btn-group" role="group">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="<?php echo tenant_base_url(); ?>/index.php?controller=admin&action=reporteProductosPDF&filtro=<?php echo $_GET['estado'] ?? 'todos'; ?>" target="_blank">
                    <i class="bi bi-file-earmark-pdf text-danger"></i> Exportar PDF
                </a></li>
                <li><a class="dropdown-item" href="<?php echo tenant_base_url(); ?>/index.php?controller=admin&action=reporteProductosExcel&filtro=<?php echo $_GET['estado'] ?? 'todos'; ?>" target="_blank">
...
<form method="GET" class="mb-4" id="productosFiltro">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <a href="<?php echo tenant_base_url(); ?>/index.php?controller=admin&action=productos" class="btn btn-secondary w-100 mt-2">
        ...
        <tbody>
            ...
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo tenant_base_url(); ?>/index.php?controller=admin&action=editarProducto&id=<?php echo $prod['id']; ?>" 
                           class="btn btn-sm btn-warning"><i class="bi bi-pencil"></i></a>
                                                <form method="POST" action="<?php echo tenant_base_url(); ?>/index.php?controller=admin&action=cambiarEstadoProducto" 
                        ...
                        <form method="POST" action="<?php echo tenant_base_url(); ?>/index.php?controller=admin&action=eliminarProducto" 
