...
class ProductoModel {
    ...
    public function crear($data) {
        ...
        $sql = "INSERT INTO productos (tenant_id, categoria_id, nombre, descripcion, precio, stock, imagen, imagen2, imagen3, numero_producto) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        
        $tipos = "iissdisssi"; // tenant_id(i), categoria_id(i), nombre(s), descripcion(s), precio(d), stock(i), imagen(s), imagen2(s), imagen3(s), numero_producto(i)
        $params = array(
            $tenant_id,
            $data['categoria_id'],
            $data['nombre'],
